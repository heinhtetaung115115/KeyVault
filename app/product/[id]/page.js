      ...
      <>
        ...
        <main style={{
          ...
          <a href="/" className="btn-primary" style={{
            marginTop: 20, display: 'inline-flex', textDecoration: 'none',
          }}>
            {t('back_to_store')}
          </a>
        </main>
      ...
      <main style={{ maxWidth: 960, margin: '0 auto', padding: '24px 20px 60px' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            {/* Price */}
            <div style={{
              fontSize: 32, fontWeight: 700, color: 'var(--brand)',
              margin: '12px 0 16px',
            }}>
            ...
            <div style={{
              ...
              />
              {emailError && (
                <p style={{ color: 'var(--danger)', fontSize: 12, margin: '0 0 10px', fontWeight: 500 }}>
                  {emailError}
                </p>
              )}
            ...
            {['description', 'details'].map(tabKey => (
              <button
                ...
                style={{
                  ...
                  borderBottom: activeTab === tabKey ? '2px solid var(--brand)' : '2px solid transparent',
                }}
              >
                {t(tabKey)}
              </button>
              ...
              <div style={{
                ...
                {isAuto && (
                  <>
                    ...
                    <span style={{ fontWeight: 600, color: stock > 0 ? 'var(--success)' : 'var(--danger)' }}>
                      {stock > 0 ? '✓' : '✕'}
                    </span>
                  </>
                )}
